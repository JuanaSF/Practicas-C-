...
/*
    10. Realizar un programa que utilizando pilas simule el juego de las torres de hanoi.
 */
...
namespace Ejercicio10
{
    public partial class Form1 : Form
    {
        ...
        private void MostrarTorre(Pila p, ListBox listBox)
        {
            Pila aux = new Pila();
            listBox.Items.Clear();
        ...
        private void HacerMovimiento(Pila pOrigen, Pila pDestino, ListBox listBoxOrigen, ListBox listBoxDestino)
        {
            try
            {
                cantidadMovimientos++;
    ...
    public class Hanoi
    {
        public Pila P1 { get; set; }
        public Pila P2 { get; set; }
        public Pila P3 { get; set; }
